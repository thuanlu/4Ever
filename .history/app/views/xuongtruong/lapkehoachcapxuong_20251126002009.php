        ...
        <div class="card-body pb-2">
            ...
            <?php if (!empty($kehoachs)): ?>
                <div class="table-responsive">
                    ...
                    <div class="col-md-4">
                        <div class="border-top pt-4 mt-2 d-flex justify-content-center">
                            <div class="card shadow-lg rounded-4 p-4 w-100" style="max-width:900px;">
                                <div class="card-header gradient-header rounded-4 mb-4">
                                    <h2 class="fw-bold mb-0 text-white">Lập Kế hoạch Cấp Xưởng</h2>
                                    <div class="mt-1 text-white">Phân bổ sản lượng từ kế hoạch tổng xuống từng ca làm việc và Tổ trưởng phụ trách.</div>
                                </div>
                                <form method="POST" action="<?= BASE_URL ?>xuongtruong/lapkehoachcapxuong/store" id="form-lapkehoach">
                                    ...
                                    <div class="mb-3 fw-bold">Tham chiếu Kế hoạch Tổng</div>
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-4">
                                            <label class="form-label">Mã Kế hoạch:</label>
                                            <input type="text" class="form-control" value="<?= $kehoach['MaKeHoach'] ?? '' ?>" readonly>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Tên Kế hoạch:</label>
                                            <input type="text" class="form-control" value="<?= $kehoach['TenKeHoach'] ?? '' ?>" readonly>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Sản lượng Tổng:</label>
                                            <input type="text" class="form-control" value="<?= number_format($kehoach['SanLuongTong'] ?? $kehoach['SanLuong'] ?? 0, 0, ',', '.') ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" class="form-control" name="ngay_bat_dau" value="<?= isset($kehoach['NgayBatDau']) ? date('Y-m-d', strtotime($kehoach['NgayBatDau'])) : '' ?>" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Ngày kết thúc</label>
                                            <input type="date" class="form-control" name="ngay_ket_thuc" value="<?= isset($kehoach['NgayKetThuc']) ? date('Y-m-d', strtotime($kehoach['NgayKetThuc'])) : '' ?>" required>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <div class="card rounded-4 p-3 shadow-sm">
                                            ...
                                            <button type="button" class="btn btn-outline-primary mt-2" onclick="addCa()"><i class="fa fa-plus"></i> Thêm ca làm việc</button>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-2 justify-content-end">
                                        ...
                                        <a href="<?= BASE_URL ?>xuongtruong/lapkehoachcapxuong" class="btn btn-secondary px-4">Hủy</a>
                                    </div>
                                </form>
                            </div>
                        </div>
