...
<body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
                    <div class="container-fluid">
                        ...
                        <a class="navbar-brand" href="<?php echo $dashboardUrl; ?>">
                            <?php echo $pageTitle ?? 'Quản lý kế hoạch'; ?>
                        </a>
    ...
    <script>
        ...
        // Add active class to current page (improved: match by path segment)
        document.addEventListener('DOMContentLoaded', function() {
            ...
            navLinks.forEach(function(link) {
                ...
                // Nếu path hiện tại bắt đầu bằng path của menu thì active
