        ...
        <div class="card-body pb-2">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <form class="d-flex" method="get" action="">
                    <input type="text" name="search" class="form-control me-2" placeholder="Tìm mã NV, tên NV" value="<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>" style="width:220px;">
                    <button type="submit" class="btn btn-outline-primary fw-bold">Tìm kiếm</button>
                </form>
                <button class="btn btn-primary fw-bold ms-2" data-bs-toggle="modal" data-bs-target="#modalAddNV"><i class="fa fa-plus"></i> Thêm nhân viên</button>
            </div>
                ...
                <table class="table table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($nv['BoPhan']) ?></td>
