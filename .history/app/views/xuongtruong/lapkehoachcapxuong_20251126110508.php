        ...
        <div class="card mb-4">
            ...
            <form method="POST" action="<?= BASE_URL ?>xuongtruong/lapkehoachcapxuong/store" id="form-lapkehoach" class="p-3">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label fw-bold">Trưởng</label>
                            <input type="text" class="form-control" name="truong" value="<?= htmlspecialchars($truong ?? '') ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ma_sp" value="<?= htmlspecialchars($maSP ?? '') ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label fw-bold">Tên sản phẩm</label>
                            <input type="text" class="form-control" name="ten_sp" value="<?= htmlspecialchars($tenSP ?? '') ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
