...
<div class="container mt-4">
    ...
    <form method="get" class="mb-3">
        ...
        <?php if (!empty($kehoach) && !empty($chitietkehoach)): ?>
            <?php 
                // $kehoach: thông tin tổng
                // $nhanvien: thông tin người lập
                // $donhang: thông tin đơn hàng
                // $chitietkehoach: mảng chi tiết sản phẩm, phân xưởng
                include APP_PATH . '/views/xuongtruong/xemchitietkehoachsanxuat.php'; 
            ?>
        <?php endif; ?>
