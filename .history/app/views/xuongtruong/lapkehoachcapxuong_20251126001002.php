                ...
                <div class="table-responsive">
                    <table class="table table-bordered mb-0 align-middle text-center">
                        <thead class="table-primary">
                            <tr>
                                <th class="fw-bold">Mã kế hoạch</th>
                                <th class="fw-bold">Tên kế hoạch</th>
                                <th class="fw-bold">Ngày bắt đầu</th>
                                <th class="fw-bold">Ngày kết thúc</th>
                                <th class="fw-bold">Người lập</th>
                                <th class="fw-bold">Đơn hàng</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="?kehoach=<?= urlencode($kh['MaKeHoach']) ?>" class="btn btn-sm fw-bold" style="background:#7b5fd4;color:#fff;">Lập kế hoạch cấp xưởng</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
            ...
            <div class="table-responsive">
                <table class="table table-bordered mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <?php if (!empty($_GET['kehoach']) && !empty($kehoach)): ?>
                        ...
                        <!-- Đã loại bỏ endif thừa ở cuối file -->