                ...
                <form method="POST" action="<?= BASE_URL ?>xuongtruong/lapkehoachcapxuong/store" id="form-lapkehoach">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-lg-3 col-md-6 mb-2">
                            <label class="form-label text-secondary">Mã xưởng trưởng</label>
                            <input type="text" class="form-control" value="<?= htmlspecialchars($maXuongTruong) ?>" readonly>
                        </div>
                        <div class="col-lg-3 col-md-6 mb-2">
                            <label class="form-label text-secondary">Tên xưởng trưởng</label>
                            <input type="text" class="form-control" value="<?= htmlspecialchars($tenXuongTruong) ?>" readonly>
                        </div>
                        <div class="col-lg-3 col-md-6 mb-2">
                            <label class="form-label text-secondary">Mã phân xưởng</label>
                            <input type="text" class="form-control" value="<?= htmlspecialchars($maPhanXuong) ?>" readonly>
                        </div>
                        <div class="col-lg-3 col-md-6 mb-2">
                            <label class="form-label text-secondary">Ngày lập kế hoạch cấp xưởng</label>
                            <input type="text" class="form-control" value="<?= date('Y-m-d') ?>" readonly>
                            <input type="hidden" name="ngay_lap" value="<?= date('Y-m-d') ?>">
                        </div>
                        <div class="col-lg-3 col-md-6 mb-2">
                            <label class="form-label text-secondary">Ngày bắt đầu</label>
                            <input type="text" class="form-control" value="<?= isset($kehoach['NgayBatDau']) ? date('Y-m-d', strtotime($kehoach['NgayBatDau'])) : '' ?>" readonly>
                            <input type="hidden" name="ngay_bat_dau" value="<?= isset($kehoach['NgayBatDau']) ? date('Y-m-d', strtotime($kehoach['NgayBatDau'])) : '' ?>">
                        </div>
                        <div class="col-lg-3 col-md-6 mb-2">
                            <label class="form-label text-secondary">Ngày kết thúc</label>
                            <input type="text" class="form-control" value="<?= isset($kehoach['NgayKetThuc']) ? date('Y-m-d', strtotime($kehoach['NgayKetThuc'])) : '' ?>" readonly>
                            <input type="hidden" name="ngay_ket_thuc" value="<?= isset($kehoach['NgayKetThuc']) ? date('Y-m-d', strtotime($kehoach['NgayKetThuc'])) : '' ?>">
                        </div>
                    </div>
                    <div id="ca-list" class="mb-3">
                        <!-- Ca làm việc động -->
                    </div>
                    <button type="button" class="btn btn-outline-primary mb-3" onclick="addCa()"><i class="fa fa-plus"></i> Thêm ca làm việc</button>
                    <div class="mb-3">
                        <label class="form-label">Công suất sơ bộ</label>
                        <div class="progress">
