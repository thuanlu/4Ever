                    ...
                    <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    <?php if (!empty($kehoach['SanPhamList']) && is_array($kehoach['SanPhamList'])): ?>
                                        <?php foreach ($kehoach['SanPhamList'] as $sp): ?>
                                            <tr>
                                                <td><?= htmlspecialchars($sp['MaSanPham'] ?? '') ?></td>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td><?= htmlspecialchars($kehoach['MaSanPham'] ?? '') ?></td>
                                            <td><?= htmlspecialchars($kehoach['TenSanPham'] ?? '') ?></td>
                                            <td><?= htmlspecialchars($kehoach['SoLuongSanPham'] ?? '') ?></td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
