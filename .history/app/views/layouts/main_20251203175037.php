        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
          <div class="container-fluid">
            ...
            <a class="navbar-brand" href="<?= htmlspecialchars($dashboardUrl) ?>">
              <?php
                // Show custom title for Xuất NVL module
                $isXuatNVL = false;
                $requestUri = $_SERVER['REQUEST_URI'] ?? '';
                if (strpos($requestUri, '/kho/xuatnguyenlieu') !== false || strpos($requestUri, '/phieuxuatnguyenlieu') !== false || strpos($requestUri, '/xuatnguyenlieu') !== false) {
                  $isXuatNVL = true;
                }
                echo $isXuatNVL ? 'Xuất nguyên vật liệu' : htmlspecialchars($pageTitle ?? 'Dashboard');
              ?>
            </a>
