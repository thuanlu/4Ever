...
// Routes cho Giám đốc (Duyệt Kế hoạch) - Dùng Controller DuyetKHSX
$router->addRoute('GET', '/giamdoc', 'DuyetKHSXController', 'index');
$router->addRoute('GET', '/giamdoc/view/(.*)', 'DuyetKHSXController', 'view');
$router->addRoute('POST', '/giamdoc/approve/(.*)', 'DuyetKHSXController', 'approve');
$router->addRoute('POST', '/giamdoc/reject/(.*)', 'DuyetKHSXController', 'reject');
