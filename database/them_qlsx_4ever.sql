...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 28, 2025 lúc 11:16 AM
...
('CTK001', 'KH001', 'SP01', 500, NULL, 0.00, 0, 'PX01'),
...
('DH001', 'Đơn hàng sản xuất dép lào', '2025-10-01', 'Đang xử lý'),
...
('P001', 'KH001', 'PX01', '2025-10-28 15:19:27', 500, 0.00, 'Chưa thực hiện');
...
('KH001', 'Kế hoạch SX dép lào', '2025-11-20', '2025-11-25', 'CN001', 'DH001', 'Chờ duyệt', 0.00, 0, '2025-10-28 15:19:27', NULL),
...
('CN001', 'Nguyễn Văn 01', 'Công nhân', 'PX01', NULL, NULL, 'Đang làm việc'),
('CN002', 'Nguyễn Văn 02', 'Công nhân', 'PX01', NULL, NULL, 'Đang làm việc'),
('CN003', 'Nguyễn Văn 03', 'Công nhân', 'PX01', NULL, NULL, 'Đang làm việc'),
('CN004', 'Nguyễn Văn 04', 'Công nhân', 'PX01', NULL, NULL, 'Đang làm việc'),
('CN005', 'Nguyễn Văn 05', 'Công nhân', 'PX01', NULL, NULL, 'Đang làm việc'),
...
--
-- Chỉ mục cho bảng `nhanvien_calam`
--
...
ALTER TABLE `phancongcalam`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `MaKHCapXuong` (`MaKHCapXuong`),
  ADD KEY `MaCa` (`MaCa`);

--
-- Chỉ mục cho bảng `phancongcalam_nhanvien`
--
ALTER TABLE `phancongcalam_nhanvien`
  ADD PRIMARY KEY (`PhanCongId`,`MaNV`),
  ADD KEY `MaNV` (`MaNV`);
...
--
-- Các ràng buộc cho bảng `nhanvien_calam`
--
ALTER TABLE `nhanvien_calam`
  ADD CONSTRAINT `nhanvien_calam_ibfk_1` FOREIGN KEY (`MaNV`) REFERENCES `nhanvien` (`MaNV`),
  ADD CONSTRAINT `nhanvien_calam_ibfk_2` FOREIGN KEY (`MaCa`) REFERENCES `calamviec` (`MaCa`);

--
-- Các ràng buộc cho bảng `phancongcalam`
--
ALTER TABLE `phancongcalam`
  ADD CONSTRAINT `phancongcalam_ibfk_1` FOREIGN KEY (`MaKHCapXuong`) REFERENCES `kehoachcapxuong` (`MaKHCapXuong`),
  ADD CONSTRAINT `phancongcalam_ibfk_2` FOREIGN KEY (`MaCa`) REFERENCES `calamviec` (`MaCa`);

--
-- Các ràng buộc cho bảng `phancongcalam_nhanvien`
--
ALTER TABLE `phancongcalam_nhanvien`
  ADD CONSTRAINT `phancongcalam_nhanvien_ibfk_1` FOREIGN KEY (`PhanCongId`) REFERENCES `phancongcalam` (`Id`) ON DELETE CASCADE,
  ADD CONSTRAINT `phancongcalam_nhanvien_ibfk_2` FOREIGN KEY (`MaNV`) REFERENCES `nhanvien` (`MaNV`);
