                ...
                <div class="mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ma_sp" value="<?= htmlspecialchars($kehoach['MaSanPham'] ?? '') ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label fw-bold">Tên sản phẩm</label>
                            <input type="text" class="form-control" name="ten_sp" value="<?= htmlspecialchars($kehoach['TenSanPham'] ?? '') ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label fw-bold">Số lượng sản phẩm</label>
                            <input type="text" class="form-control" name="so_luong_sp" value="<?= htmlspecialchars($kehoach['SoLuongSanPham'] ?? '') ?>" readonly>
                        </div>
                    </div>
                </div>
                    <div class="row g-3 mb-3">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ma_kehoach_xuong" value="<?= htmlspecialchars($maKeHoachXuong ?? '') ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label fw-bold">Tên xưởng trưởng</label>
                            <input type="text" class="form-control" name="ten_xuong_truong" value="<?= htmlspecialchars($tenXuongTruong ?? '') ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
