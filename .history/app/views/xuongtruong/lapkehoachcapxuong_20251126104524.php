...
<div class="container mt-4">
    ...
    <div class="border-top pt-4 mt-2">
        <div class="card mb-4" style="background: #f4f6fb; border-radius: 18px; box-shadow: 0 2px 12px rgba(123,95,212,0.08);">
            <div class="card-header gradient-header" style="border-radius: 18px 18px 0 0;">
            ...
            <form method="POST" action="<?= BASE_URL ?>xuongtruong/lapkehoachcapxuong/store" id="form-lapkehoach" style="padding: 2.2rem 2.2rem 1.5rem 2.2rem;">
                ...
                <div class="row g-3 mb-3 justify-content-center">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm border-0 rounded-3 p-3 h-100 bg-light">
                            <div class="fw-bold text-secondary mb-1">Sản lượng Tổng</div>
                            <div class="fs-5 fw-bold text-success"><?= number_format($kehoach['SanLuongTong'] ?? $kehoach['SanLuong'] ?? 0, 0, ',', '.') ?></div>
                        </div>
                    </div>
                </div>
                <div class="row g-3 mb-3 justify-content-center">
                ...
                <div class="mb-3">
                    <div class="card p-3 border-0 shadow-sm rounded-3" style="background:#f8f9fa; min-width: 320px;">
                ...
                <div class="mb-3">
                    ...
                    <div class="progress rounded-3" style="height:32px; background:#e9ecef;">
